...
export default function WatchVideoPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-1 lg:max-w-[calc(100%-380px)]">
            ...
            <div className="px-4 py-4">
              {/* Title */}
              <h1 className="text-white text-lg md:text-xl font-bold mb-3 leading-tight">
                {videoTitle}
              </h1>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-gray-800">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center bg-gray-800 rounded-full overflow-hidden">
                    <button 
                      onClick={handleLike}
                      className={`flex items-center gap-1.5 px-4 py-2 text-sm font-medium transition-colors ${liked ? "text-white bg-gray-700" : "text-gray-300 hover:bg-gray-700"}`}
                    >
                    ...
                    <button 
                      ...
                      className={`flex items-center px-4 py-2 transition-colors ${disliked ? "text-white bg-gray-700" : "text-gray-300 hover:bg-gray-700"}`}
                    >
                  ...
                  <button 
                    ...
                    className={`flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium transition-colors ${favorited ? "bg-red-600 text-white" : "bg-gray-800 text-gray-300 hover:bg-gray-700"}`}
                  >
                  ...
                  {/* Add to */}
                  <button className="flex items-center gap-1.5 px-4 py-2 bg-gray-800 rounded-full text-gray-300 hover:bg-gray-700 text-sm font-medium transition-colors">
                  ...
                  <button 
                    onClick={handleShare}
                    className="flex items-center gap-1.5 px-4 py-2 bg-gray-800 rounded-full text-gray-300 hover:bg-gray-700 text-sm font-medium transition-colors"
                  >
              ...
              <div className="flex items-center justify-between py-4">
                <div className="flex items-center gap-3">
                  {/* Profile Image */}
                  <Link href={`/ads/${video.listing.id}`}>
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      {profileVideos.length + 1} Videos • {location}
                    </p>
                  </div>
                </div>
              ...
              {profileVideos.length > 0 && (
                <div className="mt-6 pt-6 border-t border-gray-800">
                  <h3 className="text-white font-semibold mb-4">More from {uploaderName}</h3>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {profileVideos.map(v => (
                      <Link key={v.id} href={`/watch/${v.id}`} className="group">
                        ...
                        <p className="text-gray-300 text-xs mt-1.5 line-clamp-1">{v.title || "Video"}</p>
                        <p className="text-gray-500 text-xs">{formatViews(v.views)} views</p>
                      </Link>
                    ))}
                  </div>
                </div>
          ...
          <div className="lg:w-[380px] lg:border-l border-gray-800 p-4">
      ...
      {/* Share Toast */}
      {showShareToast && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-white text-black px-4 py-2 rounded-lg shadow-lg text-sm font-medium">
