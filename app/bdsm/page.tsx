...
export const metadata: Metadata = {
  title: "BDSM Services | RedLightAD",
  description: "Browse verified BDSM profiles on RedLightAD. Find premium BDSM services worldwide.",
}
        ...
        <div className="bg-white border-b border-gray-100">
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '12px 16px' }}>
            <div className="flex items-center gap-2">
              <h1 className="text-base font-semibold text-gray-900">BDSM</h1>
