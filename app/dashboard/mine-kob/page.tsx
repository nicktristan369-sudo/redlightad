...
export default function MinePurchasesPage() {
  ...
  return (
    <DashboardLayout>
      <div className="mb-6">
        <h1 className="text-[22px] font-bold text-gray-900">Mine køb</h1>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl border border-[#E5E5E5] text-center">
          ...
          <p className="text-[16px] font-semibold text-gray-900">Ingen køb endnu</p>
          <p className="text-[13px] text-gray-500 mt-1 mb-5">Browse marketplace for ekslusivt indhold</p>
