      ...
      <div className="space-y-6">
        ...
        {invoices.length === 0 ? (
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            {/* Table Header */}
            <div className="hidden md:grid grid-cols-5 gap-4 px-6 py-3 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 text-xs font-semibold text-gray-500 dark:text-gray-500 uppercase tracking-wide">
              <div>Invoice</div>
              <div>Description</div>
              <div>Date</div>
              <div>Amount</div>
                ...
                >
                  ...
                  <div className="hidden md:grid grid-cols-5 gap-4 items-center">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={() => openInvoicePdf(invoice.id)}
                        className="p-2 text-gray-500 hover:text-red-600 dark:hover:text-red-500 transition-colors"
                        title="Download PDF"
                      >
                        <Download size={18} />
                      </button>
