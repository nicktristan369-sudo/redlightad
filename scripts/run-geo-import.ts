...
const newCountries = [
  ...
  { iso_code: 'SA', iso3_code: 'SAU', name: 'Saudi Arabia', name_local: 'السعودية', domain: '.sa', continent: 'AS', population: 35000000 },
  { iso_code: 'QA', iso3_code: 'QAT', name: 'Qatar', name_local: 'قطر', domain: '.qa', continent: 'AS', population: 2900000 },
...
const nlRegions = [
  ...
  { geoname_id: 2759794, name: 'Drenthe', ascii_name: 'Drenthe', admin1_code: '01' },
...
// Netherlands cities
const nlCities = [
  { geoname_id: 2759794, name: 'Amsterdam', ascii_name: 'Amsterdam', latitude: 52.37403, longitude: 4.88969, population: 872680, admin1_code: '07', is_capital: true, is_major_city: true },
